        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="mt-8 md:mt-12">
            <button 
              ...
              className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 md:py-6 px-8 md:px-12 rounded-lg text-xl md:text-2xl transition-colors shadow-lg hover:shadow-xl animate-pulse"
            >
              🔥 QUERO ACABAR COM A DOR AGORA!
            <div className="flex items-start gap-4 bg-white p-4 md:p-6 rounded-lg shadow-sm">
      {/* SEÇÃO DE OFERTAS - APARECE APÓS CLICAR NO BOTÃO */}
      {showOffers && (
